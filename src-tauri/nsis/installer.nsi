; Custom NSIS template for Escribbo with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Escribbo for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Handy/Escribbo releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Escribbo Portable Mode"
    FileClose $0
